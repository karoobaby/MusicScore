...
public class WebServiceHelper {
	 ...
	 * @return serviceUrl
	 */
	public static String getServiceUrl(Context context,String keyRemoteIp) {
		
		serviceUrl="http://"+Tools.getRemoteIp(context, keyRemoteIp)+"/MusicScoreSys/DataService.asmx";
		return serviceUrl;
	}
     ...
     */
    public WebServiceHelper setIsDotNet(Boolean dotNetWebService)
    {
     ...
     */
    public WebServiceHelper setHttpTimeOut(int secondTime)
    {
     ...
     */
    public WebServiceHelper setIsDebug(Boolean isdebug)
    {
        _isdebug = isdebug;
        return this;
    }
     ...
     */
    public WebServiceHelper setOutLog(Boolean iswritelog)
    {
